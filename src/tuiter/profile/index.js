                ...
                <div className="row ms-3 mt-2">
                    <div className="col-1">
                        <Link to="/tuiter/home" className="text-secondary">
                            <FontAwesomeIcon icon="arrow-left" className="mt-3"></FontAwesomeIcon>
                        </Link>
                    </div>
                ...
                <div className="ps-4">
                    ...
                    <div className="row mb-2">
                        <div className="col-auto">
                            <FontAwesomeIcon icon="location" className="text-secondary"></FontAwesomeIcon>
                            <div className="d-inline ms-2 text-secondary">{currentUser.location}</div>
                        </div>
                        <div className="col-auto">
                            <FontAwesomeIcon icon="cake-candles" className="text-secondary"></FontAwesomeIcon>
                            <div className="d-inline ms-2 text-secondary">Born {currentUser.dateOfBirth}</div>
                        </div>
                        <div className="col-auto">
                            <FontAwesomeIcon icon="calendar" className="text-secondary"></FontAwesomeIcon>
